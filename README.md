...
Disco v0.2.0 is being packaged from source commit `e06ad0eb3e65576d80b406c7ac191562051f0c93`. The release will include a source archive, Compose files, native amd64 images, validation results, and launch video. Registry uploads and public installation verification are still pending; this README does not claim those images are available yet.
